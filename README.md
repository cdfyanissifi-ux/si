...
<body>
<div id="startDialog" class="dialog">Click on the screen!</div>

<audio id="backgroundMusic" src="miss_you/Trompette algérien (طرومبات جزائرية) (Special Version).mp3" loop></audio>
